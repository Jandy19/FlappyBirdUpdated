...
class Background{
  ...
  void loadBackground(){
    ...
    this.backgroundComponent = SpriteComponent.fromSprite(1280.0, height, this.background);
    this.backgroundComponent2 = SpriteComponent.fromSprite(1280.0, height, background2);
