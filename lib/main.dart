...
void main() async{
  ...
  if(prefs.getInt('test')==null) {
    prefs.setInt("highScore", 0);
    prefs.setInt("coinTotal", 0);
    prefs.setString("currentLink", 'monkey.png');
    prefs.setBool("ownTrump", false);
    prefs.setBool('ownNyanCat', false);
    prefs.setInt('test',0);
  }
